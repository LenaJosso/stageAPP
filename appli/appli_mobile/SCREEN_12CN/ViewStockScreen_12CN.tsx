...
export default function ViewStockScreen({
  navigation,
   ...
   const [quantiteAToRemove, setquantiteAToRemove] = useState("1");
 
   const openModal = (lot: Lot) => {
     setSelectedLot(lot);
     setquantiteAToRemove("1"); // reset à 1 à chaque ouverture
   };
 
   const closeModal = () => {
     setSelectedLot(null);
     setquantiteAToRemove("1");
   };
 
   const handleConfirmation = () => {
     if (!selectedLot) return;
 
     const quantity = parseInt(quantiteAToRemove, 10);
   ...
   const quantityEntry = parseInt(quantiteAToRemove, 10);
   const  invalidEntry =
     isNaN(quantityEntry) ||
     quantityEntry <= 0 ||
         ...
         <View style={globalStyles.modalOverlay}>
           <View style={globalStyles.modalContainer}>
             ...
             <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 8 }}>
               ...
               <TextInput
                 value={quantiteAToRemove}
                 onChangeText={setquantiteAToRemove}
